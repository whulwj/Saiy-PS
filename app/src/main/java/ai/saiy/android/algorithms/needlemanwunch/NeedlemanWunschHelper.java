 ...
 */
public class NeedlemanWunschHelper<T> implements Resolvable {
     ...
     */
    public NeedlemanWunschHelper(@NonNull final Context mContext, @NonNull final ArrayList<T> genericData,
