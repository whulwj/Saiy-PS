...
public class ContactNameHelper {
    ...
    public void buildGroups(@NonNull ArrayList<String> inputData) {
        ...
        for (String vd : inputData) {
            split = vd.split(Constants.SEP_SPACE);
            ...
            switch (length) {
                ...
                case 3:
                    ...
                    if (notInGroup) {
                        oneWordGroup.add(new Pair<>(split[0], split[1] + Constants.SEP_SPACE + split[2]));
                    }
                    notInGroup = true;
                    for (Pair<String, String> stringPair : twoWordsGroup) {
                        if (stringPair.first.matches(split[0] + Constants.SEP_SPACE + split[1])) {
                            notInGroup = false;
                        }
                    }
                    if (notInGroup) {
                        twoWordsGroup.add(new Pair<>(split[0] + Constants.SEP_SPACE + split[1], split[2]));
                    }
                ...
                case 4:
                    ...
                    if (notInGroup) {
                        oneWordGroup.add(new Pair<>(split[0], split[1] + Constants.SEP_SPACE + split[2] + Constants.SEP_SPACE + split[3]));
                    }
                    notInGroup = true;
                    for (Pair<String, String> stringPair : twoWordsGroup) {
                        if (stringPair.first.matches(split[0] + Constants.SEP_SPACE + split[1])) {
                    ...
                    if (notInGroup) {
                        twoWordsGroup.add(new Pair<>(split[0] + Constants.SEP_SPACE + split[1], split[2] + Constants.SEP_SPACE + split[3]));
                    }
                    notInGroup = true;
                    for (Pair<String, String> stringPair : threeWordsGroup) {
                        if (stringPair.first.matches(split[0] + Constants.SEP_SPACE + split[1] + Constants.SEP_SPACE + split[2])) {
                            notInGroup = false;
                        }
                    }
                    if (notInGroup) {
                        threeWordsGroup.add(new Pair<>(split[0] + Constants.SEP_SPACE + split[1] + Constants.SEP_SPACE + split[2], split[3]));
                    }
                ...
                default:
                    ...
                    if (notInGroup) {
                        ...
                        for (int i = 2; i < length; i++) {
                            stringBuilder.append(Constants.SEP_SPACE).append(split[i]);
                        }
                    ...
                    if (notInGroup) {
                        ...
                        twoWordsGroup.add(new Pair<>(split[0] + Constants.SEP_SPACE + split[1], stringBuilder.toString().trim()));
                    }
                    notInGroup = true;
                    for (Pair<String, String> stringPair : threeWordsGroup) {
                        if (stringPair.first.matches(split[0] + Constants.SEP_SPACE + split[1] + Constants.SEP_SPACE + split[2])) {
                    ...
                    if (notInGroup) {
                        ...
                        threeWordsGroup.add(new Pair<>(split[0] + Constants.SEP_SPACE + split[1] + Constants.SEP_SPACE + split[2], stringBuilder.toString().trim()));
                    }
                    notInGroup = true;
                    for (Pair<String, String> stringPair : fourWordsGroup) {
                        if (stringPair.first.matches(split[0] + Constants.SEP_SPACE + split[1] + Constants.SEP_SPACE + split[2] + Constants.SEP_SPACE + split[3])) {
                            notInGroup = false;
                        }
                    }
                    if (notInGroup) {
                        ...
                        fourWordsGroup.add(new Pair<>(split[0] + Constants.SEP_SPACE + split[1] + Constants.SEP_SPACE + split[2] + Constants.SEP_SPACE + split[3], stringBuilder.toString().trim()));
                    }
                    break;
            }
        }
