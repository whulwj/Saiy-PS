...
import ai.saiy.android.firebase.database.read.Definition;
...
public class DefinitionReference {
    ...
    private Definition getRequestWordnik() {
        ...
        com.google.firebase.database.FirebaseDatabase.getInstance().getReference(UtilsFirebase.DATABASE_READ).child("wordnik").addListenerForSingleValueEvent(new com.google.firebase.database.ValueEventListener() {
            @Override
