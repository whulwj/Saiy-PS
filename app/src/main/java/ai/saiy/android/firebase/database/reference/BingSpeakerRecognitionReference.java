...
public class BingSpeakerRecognitionReference {
    ...
    private BingSpeakerRecognition getRequestBingSpeakerRecognition() {
        ...
        com.google.firebase.database.FirebaseDatabase.getInstance().getReference(UtilsFirebase.DATABASE_READ).child("bing").child("speaker_recognition").addListenerForSingleValueEvent(new com.google.firebase.database.ValueEventListener() {
            @Override
