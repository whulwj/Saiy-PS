    ...
    static class DefaultImpl
        ...
        public double evaluateFunction(String fncnam, ArgParser fncargs) throws ArithmeticException {
            switch (Character.toLowerCase(fncnam.charAt(0))) {
                ...
                break;
                case 'g': {
                    if (fncnam.equalsIgnoreCase("getExponent")) { //needs Java 6
                ...
                break;
                case 'n': {
                    if (fncnam.equalsIgnoreCase("nextUp")) { // needs Java 6
                        return Math.nextUp(fncargs.next());
                    }
                }
                break;
                case 'r': {
                ...
                case 's': {
                    ...
                    if (fncnam.equalsIgnoreCase(SQUARE_ROOT)) {
        ...
        static void registerFunctions(MathEval tgt) {
            ...
            tgt.setFunctionHandler("getExponent", INSTANCE); // needs Java 6
            ...
            tgt.setFunctionHandler("nextUp", INSTANCE); // needs Java 6
            ...
            tgt.setFunctionHandler(SQUARE_ROOT, INSTANCE);
